...
int showMenu(){
    ...
    system("cls");
        ...
        gotoxy(3,3);
        colorit(15);
        cout<<"ROAD RACING GAME";//cout<<key<<"---"<<index;
        gotoxy(3,4);
        cout<<"================";
        gotoxy(3,5);
        colorit(15);
        ...
        cout<<"EXIT";
        gotoxy(20,12);
        colorit(15);cout<<"By: Rakibul Islam Rony\n\t\t\tTMSS Engineering College\n\t\t\tComputer Science & Engineering";colorit(15);
        gotoxy(0,0);
        ...
        if(index==1){
            ...
            ShellExecute( NULL, TEXT( "open" ), TEXT( "https://www.facebook.com/islamrj1" ), NULL, NULL, 0 );
            showMenu();
        }
        else if (index==3){
            system("cls");
            gotoxy(3,3);cout<<"ROAD RACING GAME";
            gotoxy(3,4);cout<<"By: ";colorit(12);cout<<" Rakibul Islam Rony\n\tTMSS Engineering College\n\tComputer Science & Engineering";colorit(15);gotoxy(0,0);
            Sleep(5000);
            showMenu();
        }
